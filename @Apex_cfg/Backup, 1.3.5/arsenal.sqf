	...
	[
		...
		[	
			...
			[																						
				...
				_equipmentAssignedItems,																																												// whitelisted Inventory
				(_equipmentMedic + _equipmentEngineer_ + equipmentOther + _equipmentUAV),																																// whitelisted ASSIGNED ITEMS
				_helmetsAll,																																															// whitelisted HEADGEAR
				_equipmentNVGs,																																															// whitelisted goggles
	...
	[
		...
		[	// ITEMS
			[	
				...
				(_equipmentOther),																																														// whitelisted Inventory
				(_equipmentAssignedItems),																																												// whitelisted ASSIGNED ITEMS
				(_helmetsCombat + _helmetsStealth),																																										// whitelisted HEADGEAR
				(_equipmentNVGs),																																														// whitelisted goggles
				(_attachmentsRifle)																																														// whitelisted Attachments
			],
	...
	[
		...
		[	// ITEMS
			[	
				(_attachmentsHelmet + _uniformsClothCovering + _uniformsMasks + _uniformsFormal + _uniformsArmour),																										// whitelisted UNIFORMS
				(_vestsHeavy + _vestsLight + _vestsCrew + _vestsStrapsBandoliers),																																		// whitelisted VESTS
				(_equipmentMedic + _equipmentOther),																																									// whitelisted Inventory
				(_equipmentAssignedItems),																																												// whitelisted ASSIGNED ITEMS
				(_helmetsCombat + _helmetsStealth),																																										// whitelisted HEADGEAR
				(_equipmentNVGs),																																														// whitelisted goggles
				(_attachmentsRifle)																																														// whitelisted Attachments
...
if (_role in ['engineer']) exitWith {
	[
		...
		[	// ITEMS
			[	
				(_attachmentsHelmet + _uniformsClothCovering + _uniformsMasks + _uniformsFormal + _uniformsArmour),																										// whitelisted UNIFORMS
				(_vestsHeavy + _vestsLight + _vestsMedic +_vestsCrew + _vestsStrapsBandoliers),																															// whitelisted VESTS
				(_equipmentEngineer + _equipmentOther),																																									// whitelisted Inventory
				(_equipmentAssignedItems),																																												// whitelisted ASSIGNED ITEMS
...
if (_role in ['pilot','pilot_plane','pilot_cas','pilot_heli','pilot_heli_WL']) exitWith {
	[
		...
		[	// ITEMS
			[	
				(_uniformsArmour + _uniformsCoveralls),																																									// whitelisted UNIFORMS
				(_vestsCrew + _vestsStrapsBandoliers),																																									// whitelisted VESTS
				(_equipmentOther),																																														// whitelisted Inventory
				(_equipmentAssignedItems),																																												// whitelisted ASSIGNED ITEMS
				(_helmetsPilot),																																														// whitelisted HEADGEAR
				(_equipmentNVGs),																																														// whitelisted goggles
				(_attachmentsRifle)																																														// whitelisted Attachments
			],
			(_magazinesPistol + _magazinesCarbine + _magazinesRifle + _magazinesAssault + _magazinesUGL + _magazinesStun + _grenadesChemlights + _grenadesSmoke + _grenadesOffensive + _explosivesInfantry),			// whitelisted MAGAZINES
	...
	[
		...
		[	// ITEMS
			[	
				...
				(_vestsHeavy + _vestsLight + _vestsCrew + _vestsStrapsBandoliers),																																		// whitelisted VESTS
				(_equipmentOther),																																														// whitelisted Inventory
				(_equipmentAssignedItems + _equipmentUAV),																																								// whitelisted ASSIGNED ITEMS
				(_helmetsCombat + _helmetsStealth),																																										// whitelisted HEADGEAR
				(_equipmentNVGs),																																														// whitelisted goggles
				(_attachmentsRifle + _attachmentsSniper)																																								// whitelisted Attachments
			],
