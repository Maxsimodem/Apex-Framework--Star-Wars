...
_serverRules = '- No teamkilling<br/>- No deliberate destruction of friendly assets<br/>- No advertising<br/>- No verbal abuse';						// Server rules shown on splash screen text. Structured Text. Note: There are more rules listed in "code\functions\fn_clientDiary.sqf", edit that file to your liking.
_staffNames = 'Undetermined (admin), Undetermined (moderator), Undetermined (moderator), Undetermined (Zeus) Undetermined (Zeus)';						// This text gets shown on the splash screen when player enters the game, customize as you like.
...
_recruitableAI = 0;										// Recruitable AI.	0 - Disabled. 1 - Enabled. 		If there are recruitable AI available (default base layout or placed by you in custom base layout), this toggles them on or off.
...
_effectKnockdown = 0;									// Knock-Down effect.	0 - Disabled. 1 - Enabled (Default).	Player can be knocked down by nearby explosions.
...
_tracers = 2;											// Tracer bullets. 0 - Vanilla handling. 1 - At night and low-pop times, AI get tracer bullets. 2 - AI get tracers at all times. Default - 1.
...
_dynamic_simulation = 0;								// Dynamic Simulation. 	0 - Disabled. 1 - Enabled. 	Raises FPS and performance slightly. Server freezes entities which are far away from all players.    Info: https://community.bistudio.com/wiki/Arma_3_Dynamic_Simulation
_timeMultiplier = [										// Time Multiplier. Set all values to 1 for real-time.
	...
	1.5					// Morning/Evening/Dawn/Dusk time acceleration multiplier. Default - 0.35.
];
...
_default_flag_texture = '\media\images\general\flag_Republic.jpg';																	// Texture applied to friendly flags. 			Default: 'a3\data_f\flags\flag_nato_co.paa'
//Community Billboards
_billboardCommunity1 = ['media\images\billboards\billboard1.jpg','media\images\billboards\billboard1.jpg'];					// Textures applied to blank billboards in the default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
_billboardCommunity2 = ['media\images\billboards\billboard2.jpg','media\images\billboards\billboard2.jpg'];					// Textures applied to blank billboards in the default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
_billboardCredits3 = ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard3.jpg'];					// Textures applied to blank billboards in the default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
_billboardCredits4 = ['media\images\billboards\billboard4.jpg','media\images\billboards\billboard4.jpg'];					// Textures applied to blank billboards in the default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
//Screens
_billboardScreen5 = ['media\images\billboards\billboard5.jpg','media\images\billboards\billboard5.jpg'];					// Textures applied to livefeed screen in default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
_billboardScreen6 = ['media\images\billboards\billboard6.jpg','media\images\billboards\billboard6.jpg'];					// Textures applied to other screens in default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
//Pinups
_infostand_1 = ['media\images\billboards\billboard7.jpg','media\images\billboards\billboard7.jpg'];							// Textures applied to info stands (V1) in default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];
_infostand_2 = ['media\images\billboards\billboard8.jpg','media\images\billboards\billboard8.jpg'];							// Textures applied to info stands (V2) in default base. These parameters act as randomized arrays. Put more file paths in the [ ] array as desired. Example:   ['media\images\billboards\billboard3.jpg','media\images\billboards\billboard4.jpg'];

//===================================================== SECURITY

_serverCommandPassword = "'ValeurDelta#304'";			// Enter a server command password like this. It MUST match servercommandpassword from your server.cfg config file. ---> serverCommandPassword = "ShVQArtpGdc5aDQq"; This is important and some mission systems will not function without it.
...
};
{
	...
	['QS_missionConfig_textures_billboard1',_billboardCommunity1,TRUE],
	['QS_missionConfig_textures_billboard2',_billboardCommunity2,TRUE],
	['QS_missionConfig_textures_billboard3',_billboardCredits4,TRUE],
	['QS_missionConfig_textures_billboard4',_billboardCredits3,TRUE],
	['QS_missionConfig_textures_billboard5',_billboardScreen5,TRUE],
	['QS_missionConfig_textures_billboard6',_billboardScreen6,TRUE],
