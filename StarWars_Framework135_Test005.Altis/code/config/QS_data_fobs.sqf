...
* 
* Synopsis						:	This file contains the FOB compositions
* 
* Framework Version				:	1.3.5
* 
* Modification Date				:	2023-07-23
* 
* Modification Description		:	Changed default FOBs to use Star Wars props in their corresponding locations. Increased
*									documentation
* 
...
/*---------------------------------------------------------------------------------------------------------------------------
*
*	To create your own FOBs, first locate the FOB you wish to change. Use the paste code below in addition to the prop list
*	on the corresponding map, and make edits accordingly. It is not recommended to change layout, only props. After your
*	FOB is complete, select everything and run the copy code, and then paste and format accordingly. Tips for simulation
*	states are at the bottom of this note.
*
